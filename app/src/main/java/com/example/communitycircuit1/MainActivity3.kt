...
import com.example.communitycircuit1.databinding.ActivityMain3Binding
...
class MainActivity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val campaignBeneficiary = intent.getStringExtra("campaignBeneficiary") // Retrieve campaignAbout
        val campaignNumber = intent.getStringExtra("campaignNumber")
        ...
        binding.addNumber.text = campaignNumber
